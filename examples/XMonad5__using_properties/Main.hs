...
myStackSet :: T
myStackSet = StackSet {current = Screen {workspace = Workspace {tag = NonNegative 4, layout = 1, stack = Just (Stack {focus = 'e', up = "", down = ""})}, screen = 1, screenDetail = 1}, visible = [Screen {workspace = Workspace {tag = NonNegative 2, layout = 1, stack = Nothing}, screen = 0, screenDetail = 1}], hidden = [Workspace {tag = NonNegative 0, layout = 1, stack = Nothing},Workspace {tag = NonNegative 1, layout = 1, stack = Nothing},Workspace {tag = NonNegative 3, layout = 1, stack = Just (Stack {focus = 'a', up = "", down = "w"})}], floating = M.fromList []}
